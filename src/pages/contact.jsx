...
const ContactPage = () => {
  return (
    <section className="relative">
      ...
      >
        <div className="absolute left-1/2 transform -translate-x-1/2 w-full max-w-4xl px-4 sm:px-6 lg:px-8 py-6">
          <div className="bg-white bg-opacity-95 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden">
            <div className="relative">
              <img
                ...
                className="w-full h-64 md:h-80 lg:h-102 object-cover"
              />
      ...
      <div className="pt-0 md:pt-4 lg:pt-6 px-4 lg:px-8">
